    ...
    <div className="printable min-h-screen bg-black text-cream">
      ...
      <main className="shell py-16 sm:py-24">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h1 className="mt-2 text-5xl sm:text-7xl">{t.menuPage.title}</h1>
          <p className="mt-4 text-cream/60">{t.footer.tagline}</p>
        </div>
                ...
                {category.items.map((item) => {
                  ...
                  return (
                    <li key={item.id} className="flex items-baseline justify-between gap-4">
                      <div>
                        <h3 className="font-serif text-xl text-cream">{copy.name}</h3>
        ...
        <div className="mx-auto mt-20 max-w-3xl border-t border-cream/15 pt-8 text-center text-sm text-cream/55">
          ...
          <p className="mt-1">{t.menuPage.currencyNote}</p>
        </div>
      </main>
    </div>
  );
